...
import "./wedding-event-form.component.css";
import { saveWeddingDayData } from "../../../../services/user/event-catagoryservice/wedding-event.service";
import WeddingEventView from "./wedding-event-view.component";
...
export const WeddingEvent = () => {
  ...
  function validateEvent(data) {
    data.id = "";
    saveWeddingDayData(data).then((res) => {
  ...
  return (
    <div className="m-3 p-3" style={{color:"whitesmoke"}}>
      <h3 className="text-center p-3 m-3">WEDDING-EVENT-FORM</h3>
      <form
